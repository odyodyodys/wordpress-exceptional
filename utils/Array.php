 ...
 * @author Odys
 */
class Exceptional_Array extends Exceptional_AController
{    
    /**
     ...
     */
    public function Having($objects, $property, $valueExpr, $all = false)
    {
     ...
     */
    public function Values($objects, $property)
    {
        $values = array();
        foreach ($objects as $obj)
        {
